                    ...
                    <div class="btn-group">
                        ...
                        ?>
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="changepass.php" class="dropdown-item active" type="button">change password</a>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    <div id="success"></div>
                    <form method="post" action="change.php" name="sentMessage" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            <input name="oldpassword" type="password" class="form-control" id="password" placeholder="old password"
                                required="required" data-validation-required-message=" new password" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <input name="npassword" type="password" class="form-control" id="password" placeholder="conform password"
                                required="required" data-validation-required-message="conform password" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
                            <button name="login" class="btn btn-primary py-2 px-4" type="submit" id="sendMessageButton">Submit</button>
                        </div>
                    </div>
                    </form>
                </div>
