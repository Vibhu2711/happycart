...
<body>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    <div id="success"></div>
                    <form  method="post" action="register2.php" onsubmit="return validateForm()" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            <input type="text" name="phone" class="form-control" id="phone" placeholder="Your Mobile"/>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <input type="text" name="address" class="form-control" id="addr" placeholder="Your address"/>
                            <p class="help-block text-danger"></p>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <p>Have already an account?
                                <a href="signin.php"><u>Login here</u></a>
                            </p>
                        </div>
                    </form>
                </div>
	...
	function validateForm()
    {
        ...
        // Regular expression for validating name (only letters and spaces, 3-30 characters)
        var namePattern = /^[A-Za-z\s]{3,30}$/;
        if (!namePattern.test(name)) {
            alert("Name should only contain letters and spaces, between 3 to 30 characters.");
        ...
        // Regular expression for validating phone number (assuming format like (123) 456-7890)
        ...
        // Strong password validation (minimum 8 characters, at least one uppercase, one lowercase, one number, one special character)
        var passwordPattern = /^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)[A-Za-z\d@$!%*#?&]{8,}$/g;
        ...
        // If all fields are valid, redirect to another page by name (e.g., "success.html")
        alert("Form submitted successfully!");
        window.location.href = "signup.php";  // Redirect to success.html (page name)
