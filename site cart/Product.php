                    ...
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
                            ...
                            <div class="product-action">
                                ...
                                <a class="btn btn-outline-dark btn-square" href="like.php?id=<?php echo $row["pid"]; ?>"><i class="far fa-heart"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="Productdetail.php?id=<?php echo $row["pid"]; ?>"><?php echo $row["pname"]; ?></a>
                            <div class="d-flex align-items-center justify-content-center mt-2" >
                                <h5><?php echo $row["pprice1"]; ?></h5><h6 class="text-muted ml-2"><del><?php echo $row["pprice2"]; ?></del></h6>
                            </div>
