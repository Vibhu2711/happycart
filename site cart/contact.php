				...
				<div class="row">
					<div class="col-md-6">
                        ...
                        <div class="bg-light p-30 mb-3">
                            ...
                            <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+91 7096562610</p>
                        </div>
					</div>
					<div class="col-md-6">
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<input type="submit" onclick="sendEmail()" name="submit"  value="Send Message" class="btn btn-primary">
								</div>
							</div>
						</div>
					</div>
