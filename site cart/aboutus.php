    ...
    <div class="fh5co-section-gray">
        <div class="row" class="fh5co-section-gray">
            <div class="col-md-12" >
                <div class="fh5co-team text-center animate-box">
                    <figure>
                        <img src=".\admin\image\sir.jpeg" alt="user" width="200" height="200">
                    </figure>
                    <div>
                        <h3>MR. Adarsh Patel</h3>
                        <p><span>Professor</span></p>
                        <p>contact@arthconsultancyservices.com</p>
...
<p class="fh5co-team text-center animate-box">__________________________________________________________________</p>
<div id="fh5co-content-section">
<div class="container">
    <div class="col-md-12">
        <div class="fh5co-team text-center animate-box">
    ...
    <div class="fh5co-section-gray">
        <div class="row" class="fh5co-section-gray">
            <div class="col-md-12" >
                <div class="fh5co-team text-center animate-box">
                    <figure>
                        <img src="admin\image\vaibhavi.jpeg" alt="user" width="200" height="200">
                    </figure>
                    <div>
                        <h3>Zala Vaibhavi</h3>
                        <p><span>Student</span></p>
                        <p>vaibhavizala27@gmail.com</p>
